/**
 *  Copyright 2015 Abhishek Sharma
 *
 ...
 *
 *  Left It Open When Armed
 *
 *  Author: Abhishek Sharma
 */
definition(
    name: "Left It Open When Armed",
    namespace: "abhishekbiyala",
    author: "abhishekbiyala",
    description: "Notifies you when you have left a door or window open when smart home monitor is in Away or Night state.",
